        ...
        <div className="bg-[#111111a0] backdrop-blur-[20px] border border-[#ffffff0a] px-5 py-4 rounded-[12px] flex items-center justify-between shadow-2xl relative z-10">
          ...
          <div className="flex items-center gap-3">
            ...
            <button
              ...
              className="w-8 h-8 flex items-center justify-center bg-[#ffffff0a] hover:bg-[#ffffff15] border border-[#ffffff10] rounded-full text-slate-400 hover:text-slate-100 transition-all duration-200 shadow-lg ml-1"
              title="Close"
            >
              <X className="w-4 h-4" />
            </button>
